...
import { LayoutDashboard, Package, ShoppingBag, Users, Tag, Receipt, FileBarChart, Calculator, BarChart3, LogOut } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-bg flex">
      <aside className="w-56 bg-brand text-white flex-shrink-0 hidden md:flex flex-col">
        <div className="p-6">
          <Link to="/admin" className="text-lg font-extrabold tracking-tight uppercase">BY BISA</Link>
        ...
        <div className="p-3">
          <button onClick={() => { sessionStorage.removeItem('bybisa-admin'); setAuthenticated(false) }}
